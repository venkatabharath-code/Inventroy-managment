...
const RegisterAssetModal = ({ isOpen, onClose, onSuccess }) => {
  ...
  return (
    <div className="ra-modal-overlay" onClick={onClose}>
      <form className="ra-modal-container" onClick={e => e.stopPropagation()} onSubmit={handleSubmit}>
        {/* Modal Header */}
        <div className="ra-modal-header">
          <h2 className="ra-modal-title">Register New Asset</h2>
        {/* BUG-010: type=button prevents accidental form submit on close */}
        <button type="button" className="ra-modal-close" onClick={onClose} aria-label="Close modal" data-testid="ra-modal-close">
            <RiCloseLine size={24} />
          </button>
        </div>
          ...
          <div className="ra-section">
            ...
            <div className="ra-form-row">
              <div className="ra-input-group ra-full-width">
                ...
                <input type="text" name="name" value={formData.name} onChange={handleInputChange} placeholder="e.g., MRI Machine - Siemens 3T" required />
              </div>
            </div>
            <div className="ra-form-row">
              ...
              <div className="ra-input-group ra-half-width">
                ...
                <input id="ra-serial" type="text" name="serialNumber" value={formData.serialNumber} onChange={handleInputChange} placeholder="Enter serial number" required data-testid="ra-serial" />
              </div>
            </div>
            <div className="ra-form-row">
              <div className="ra-input-group ra-half-width">
                <label htmlFor="ra-manufacturer">Manufacturer</label>
                <input id="ra-manufacturer" type="text" name="manufacturer" value={formData.manufacturer} onChange={handleInputChange} placeholder="Equipment manufacturer" data-testid="ra-manufacturer" />
              </div>
              <div className="ra-input-group ra-half-width">
                <label htmlFor="ra-model">Model Number</label>
                <input id="ra-model" type="text" name="modelNumber" value={formData.modelNumber} onChange={handleInputChange} placeholder="Model/version" data-testid="ra-model" />
              </div>
            </div>
          </div>

          {/* Section 2: Location & Value */}
          <div className="ra-section">
            ...
            <div className="ra-form-row">
              ...
              <div className="ra-input-group ra-half-width">
                ...
                <input type="text" name="value" value={formData.value} onChange={handleInputChange} placeholder="Purchase price" required />
              </div>
            </div>
            <div className="ra-form-row">
              <div className="ra-input-group ra-half-width">
                <label>Purchase Date <span className="ra-required">*</span></label>
                <input type="date" name="purchased" value={formData.purchased} onChange={handleInputChange} required />
              </div>
              <div className="ra-input-group ra-half-width">
                <label htmlFor="ra-supplier">Supplier/Vendor</label>
                <input id="ra-supplier" type="text" name="supplier" value={formData.supplier} onChange={handleInputChange} placeholder="Supplier name" data-testid="ra-supplier" />
              </div>
            </div>
          </div>
          ...
          <div className="ra-section ra-section-last">
            ...
            <div className="ra-form-row">
              <div className="ra-input-group ra-half-width">
                ...
                <input type="date" name="warrantyExpires" value={formData.warrantyExpires} onChange={handleInputChange} />
              </div>
              <div className="ra-input-group ra-half-width">
                <label htmlFor="ra-amc">AMC (Annual Maintenance Contract)</label>
                <input id="ra-amc" type="text" name="amc" value={formData.amc} onChange={handleInputChange} data-testid="ra-amc" />
              </div>
            </div>
            <div className="ra-form-row">
              <div className="ra-input-group ra-half-width">
                <label htmlFor="ra-maint-freq">Maintenance Frequency</label>
                <input id="ra-maint-freq" type="text" name="maintenanceFrequency" value={formData.maintenanceFrequency} onChange={handleInputChange} data-testid="ra-maint-freq" />
              </div>
              <div className="ra-input-group ra-half-width">
        ...
        <div className="ra-modal-footer">
          <button type="submit" className="ra-btn-submit" disabled={isSubmitting}>
            <RiSaveLine size={16} /> {isSubmitting ? 'Registering...' : 'Register Asset'}
          </button>
